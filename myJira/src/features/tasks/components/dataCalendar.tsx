...
const CustomToolBar= ({date, onNavigate}:CustomToolBarProps)=>{
    return <div className='flex mb-4 gap-x-2 items-center w-full lg:w-auto justify-center lg:justify-start'>
...
const DataCalendar = ({data}: DataCalendarProps) => {
  ...
  return (
    <Calendar localizer={localizer} date={value} events={events} views={['month']}
        defaultView= "month"
        toolbar
        showAllEvents
        className="h-full"
