...
// import { insertWorkSheduleLineSchema, InsertWorkSheduleLineSchema } from "@/db/schema";

// const WorkScheduleLines = () => {
//   type WorkScheduleFormType = InsertWorkSheduleLineSchema;
...
//     control,
//     name: "lines" as keyof WorkScheduleFormType,
//   });

//   const onSubmit = (data: WorkScheduleFormType) => {
...
//                       name={`lines.${index}.${f.field}` as keyof WorkScheduleFormType}
//                       render={({ field }) => (
//                         <FormItem>
//                           <FormControl>
//                             {f.type === "input" ? (
//                               <Input className="border-none ring-0 bg-transparent" {...field} name={String(field.name)} value={String(field.value)} placeholder={f.placeholder} />
//                             ) : (
//                               <Select
