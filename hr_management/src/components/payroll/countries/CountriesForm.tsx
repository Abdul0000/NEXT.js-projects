...
const CountryForm = ({country_id}:CountryFormProps) => {
  ...
  const updateCountry = trpc.settings.updateCountry.useMutation({
    onSuccess: () => {
      ...
      utils.settings.getOneCountry.invalidate({ country_id });
