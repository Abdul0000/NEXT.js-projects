...
import WorkingShedules from "@/components/payroll/resources/WorkingShedules"
...
const page = async() => {
  ...
  void queryClient.prefetchQuery(trpc.settings.getAllWorkingShedulesPage?.queryOptions({page,perPage}))
  return (
