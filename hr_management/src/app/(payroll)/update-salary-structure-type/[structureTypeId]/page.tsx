...
const page = async({params}:Props) => {
  ...
  void queryClient.prefetchQuery(
    trpc.payroll.getOneSalaryStructuretype?.queryOptions({
      structure_type_name: '', // TODO: replace with actual value
      country_id: '', // TODO: replace with actual value
      wage_type: '', // TODO: replace with actual value
      sheduled_pay: 'monthly', // TODO: replace with actual value
    })
  )
  return (
